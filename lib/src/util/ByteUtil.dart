...
Uint8List int32ToBytes(int val) {
  if (val >= 2147483648 || val < -2147483648)
    throw new ArgumentError(
        "Integer exceeds 32 bits(-2147483648 ~ 2147483647)");
...
Uint8List int64ToBytes(int val) {
  ...
  if (val.bitLength > 64)
    throw new ArgumentError(
        "Integer exceeds 64 bits(-9223372036854775808 ~ 9223372036854775807)");
