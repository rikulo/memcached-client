...
/** A Unlock Operation of binary protocol */
class BinaryUnlockOP extends SingleKeyOP implements UnlockOP {
  final Completer _cmpl; //completer to complete the future of this operation

  Future<bool> get future => _cmpl.future;

  BinaryUnlockOP(String key, int cas)
      : _cmpl = new Completer(),
        super(key) {
